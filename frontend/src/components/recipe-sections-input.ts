...
function sectionRow(section?: string) {
	return $`
...
export function recipeSectionsInput(sections?: readonly string[]) {
	sections ??= [];

	return $`
		<div id="sections-nojs-parent">
			<label for="nojs-sections" class="form-label">Sections</label>
			<textarea
				type="text"
				name="nojs-sections"
				id="nojs-sections"
		...
		<div class="d-none" id="js-sections">
			<label for="js-sections-input" class="form-label">Sections</label>
